--game.Players:Chat("-gh 5154115297")
...
local hat = Align(char['Sniper'].Handle,Barrel,false)
hat[1].CFrame = CFrame.new(3.8,0,0)*CFrame.Angles(math.rad(90),math.rad(0),math.rad(90))
